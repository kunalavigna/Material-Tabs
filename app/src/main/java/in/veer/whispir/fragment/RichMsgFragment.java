 ...
 */
public class RichMsgFragment extends Fragment {
    Button button;
    EditText edtTo, edtSub, edtBody, edtWebBody;
    String data ="";
    ...
    public static Fragment newInstance(Context context) {
        RichMsgFragment f = new RichMsgFragment();
        return f;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_rich_msg, null);
        ...
        edtWebBody = (EditText) root.findViewById(R.id.edt_web_body);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    jsonParam2.put("body", edtWebBody.getText().toString());
